        ...
        <div class = "card-body">
            <form method="POST" action="{{route('quizzes.store')}}">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="title" style="margin-bottom: 10px;" class="form-control" required>
                </div>
                <div class="form-group">
                    <label>Quiz Description</label>
                    <textarea name="description" style="margin-bottom: 10px;" class="form-control" rows="4"></textarea>
                </div>
                <div class="form-group">
